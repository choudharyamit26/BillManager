"""
Django settings for Gstmanager project.
...
SECRET_KEY = 'flk-6sp)0mdg-g(w8e3(s8prs4bb^m6+!yq(4kidc-_%#5y(ln'
...
WSGI_APPLICATION = 'Gstmanager.wsgi.application'
